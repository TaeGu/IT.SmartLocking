...
public class MailSend {
	...
	public MailSend(String timestamp, double a, double b, int function,String emails){ 
		//메일 전송
        ...
        if(function == 1)
        {
        	subject = "SmartLocking : 누군가가 기기를 잠금해제하려고 합니다!";
        }
        else if(function == 2)
        {
        	subject = "SmartLocking : 신호탄이 실행되었습니다!";
        }
        else if(function == 3)
        {
        	subject = "SmartLocking : USIM 카드 감지가 실행되었습니다!";
        }
        ...
        try{
        	...
        	email.sendMailWithFile(subject, body, "IT.SmartLocking@gmail.com", emails,
